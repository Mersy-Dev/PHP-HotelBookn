						...
						<div class="half left-arrow d-flex align-items-center">
							<div class="text p-4 p-xl-5 text-center">
								...
								<ul class="list-accomodation">
									...
									<li><span>Size:</span> <?php echo $room->size; ?> m<sup>2</sup></li>
									<li><span>View:</span> <?php echo $room->view; ?></li>
									<li><span>Bed:</span> <?php echo $room->num_beds; ?> beds</li>
								</ul>
								<p class="pt-1">
									<a href="<?php echo APPURL; ?>rooms/room-single.php?id=<?php echo $room->id; ?>" class="btn-custom px-3 py-2">
