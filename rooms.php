						...
						<div class="room-wrap d-md-flex">
							...
							<div class="half left-arrow d-flex align-items-center">
								<div class="text p-4 p-xl-5 text-center">
									...
									<p class="mb-0"><span class="price mr-1">$<?php echo $rooms->price; ?></span> <span class="per">per night</span></p>
									<h3 class="mb-3"><a href="rooms/room-single.php?id=<?php echo $rooms->id; ?>"><?php echo $rooms->name; ?></a></h3>
									...
									<p class="pt-1"><a href="rooms/room-single.php?id=<?php echo $rooms->id; ?>" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
								</div>
							</div>
						</div>
					</div>
